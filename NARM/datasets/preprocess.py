...
parser.add_argument('--dataset', default='diginetica', help='dataset name:diginetica/yoochoose/sample/amex_log-poi/amex_log-category/amex_log-context/amex_explorepoi-poi_category/amex_explorepoi-poi_context/amex_explorepoi-category/amex_explorepoi-context')
...
dataset_path = '/home/ubuntu/michelle_ML/s3_file_processing/dataset_files/amex-datasets-yoochoose-format/'
#amex log datasets
with open('/michelle_ML/amex_yoochooseformat_dataset/amex_log_poi_clicks.dat', 'r') as f, open('amex_log_poi_clicks-withHeader.dat', 'w') as fn:
    fn.write('sessionId,timestamp,itemId,category'+'\n')
    for line in f:
        fn.write(line)        
with open('amex_log_category_clicks.dat', 'r') as f, open('amex_log_category_clicks-withHeader.dat', 'w') as fn:
    fn.write('sessionId,timestamp,itemId,category'+'\n')
    for line in f:
        fn.write(line)
with open('amex_log_context_clicks.dat', 'r') as f, open('amex_log_context_clicks-withHeader.dat', 'w') as fn:
    fn.write('sessionId,timestamp,itemId,category'+'\n')
    for line in f:
        fn.write(line)
        
#amex explore_POI datasets       
with open('AMEX_explorepoi_poi_category_clicks.dat', 'r') as f, open('AMEX_explorepoi_poi_category_clicks-withHeader.dat', 'w') as fn:
    fn.write('sessionId,timestamp,itemId,category'+'\n')
    for line in f:
        fn.write(line)
with open('AMEX_explorepoi_poi_context_clicks.dat', 'r') as f, open('AMEX_explorepoi_poi_context_clicks-withHeader.dat', 'w') as fn:
    fn.write('sessionId,timestamp,itemId,category'+'\n')
    for line in f:
        fn.write(line)
with open('AMEX_explorepoi_category_clicks.dat', 'r') as f, open('AMEX_explorepoi_category_clicks-withHeader.dat', 'w') as fn:
    fn.write('sessionId,timestamp,itemId,category'+'\n')
    for line in f:
        fn.write(line)
with open('AMEX_explorepoi_context_clicks.dat', 'r') as f, open('AMEX_explorepoi_context_clicks-withHeader.dat', 'w') as fn:
    fn.write('sessionId,timestamp,itemId,category'+'\n')
    for line in f:
        fn.write(line)
